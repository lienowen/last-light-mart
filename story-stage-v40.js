...
const stageSceneAssets={
  dawn:'assets/story/opening-suyan-store-v4.webp',
  ...
  c2_suyan:'assets/story/suyan-underpass-trap-v3.webp',
...
investigations.dawn=[['ledger',64,82,'库存清单','药品那一行被刚沾过雨水的手指抹花，苏妍进门前就知道你少了药。'],['lock',35,84,'旧仓钥匙','钥匙旁有一道新鲜红漆，和远处屋顶天线底座的颜色一致。']];
dialogues.dawn=['苏妍：二十八岁，前战地护士。很多人先注意我的穿着，再注意我手里有没有武器——我靠这个时间差活下来。','苏妍：外面那辆救护车不是我的。有人把伤员和陷阱一起留给了我。你想救人，就别只相信我说的话。'];
...
dialogues.alley=['苏妍：过来扶我，或者继续盯着那根线。你只有五秒。','苏妍：我靠别人低估我活到现在。你没上当，所以我愿意告诉你诊所真正的入口。'];
investigations.alley=[['wire',70,79,'积水绊线','钢丝横穿水面，触发后会让空罐暴露你的位置；它不是杀人机关，是给巡逻车报点。'],['cleanboot',35,74,'避水落脚点','她的靴子正踩在唯一不会牵动钢丝的位置，伸出的手也是在引导你落脚。']];
...
applyDirectorShot=function(type,options={}){
  ...
  if(profile){
    ...
    directorScene.style.setProperty('--shot-size','158%');
...
const routeScenes={
  ...
  'alley>clinic':{asset:'assets/story/suyan-trap-integrated-v2.webp',title:'她说的近路 · 货车后巷',text:'苏妍走得很慢，像在等你靠近。她的紧身黑裤和雨衣吸引视线，脚边的积水却安静得反常。',scan:'低头检查积水',x:72,y:67,safe:'从货车左侧绕过去',bold:'跟着她跨过钢丝',safeText:'你没有盯着她，反而看清绊线连着三只铁罐。苏妍的笑停了半秒。',boldText:'她在最后一步突然侧身。你差点撞上钢丝，只能用手护住背包。'},
  ...
  'c2_roof>c2_suyan':{asset:'assets/story/suyan-underpass-trap-v3.webp',title:'高架桥下 · 求救手势',text:'定位信号钻进积水隧道。苏妍靠着翻倒货车向你伸手，右侧被压住的快递员却在拼命摇头。',scan:'看水面横线',x:55,y:76,safe:'先沿墙检查她身侧',bold:'伸手把她拉起来',safeText:'你的灯扫出贴着水面的绊线，她藏在腿侧的手正按着遥控器。',boldText:'她抓住你的手借力站起，脚尖却把绊线推向你。你只剩半步反应。'},
...
/* The alley already contains the wire trap; the next route should reveal the clinic, not replay it. */
delete routeScenes['alley>clinic'];
