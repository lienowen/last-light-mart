...
for(const entry of entries){
  ...
  if(!html.includes('story-v56.js?v=56'))fail.push(`${entry}: v56 not wired`);
  if(!html.includes('<script async src="https://sdk.crazygames.com/crazygames-sdk-v3.js"></script>'))fail.push(`${entry}: CrazyGames SDK must be non-blocking`);
...
console.log('MARKET SMOKE PASSED: v56 boot, entries, assets and core scripts verified.');