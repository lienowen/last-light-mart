...
for(const entry of entries){
  ...
  if(styles.length!==1||!styles[0].startsWith('app-v61.css'))fail.push(`${entry}: expected exactly one v61 stylesheet`);
...
if(!exists('app-v60.js')||!exists('app-v60.css')||!exists('app-v61.css'))fail.push('current app files missing');
...
if(exists('app-v60.js')){
  ...
  if([...source.matchAll(/asset:\s*['"]([^'"]+)['"]/g)].some(match=>match[1].includes('suyan-western-transparent')))fail.push('independent Su Yan sprite layer returned');
